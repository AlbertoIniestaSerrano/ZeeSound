...
class MoogKnobCtrl(KnobCtrl):
    def __init__(self, parent, id=wx.ID_ANY, pos=wx.DefaultPosition,
        ...
        if size==(256,256):
            self.bmp_back=wx.Bitmap("img/sets/moog_opus/knob_back_256.png")
            self.bmp_fore=wx.Bitmap("img/sets/moog_opus/knob_fore_256.png")
            self.bmp_plate=wx.Bitmap("img/sets/moog_opus/knob_plate_256.png")
        elif size == (128,128):
            self.bmp_back=wx.Bitmap("img/sets/moog_opus/knob_back_128.png")
            self.bmp_fore=wx.Bitmap("img/sets/moog_opus/knob_fore_128.png")
            self.bmp_plate=wx.Bitmap("img/sets/moog_opus/knob_plate_128.png")
        elif size == (64,64):
            self.bmp_back=wx.Bitmap("img/sets/moog_opus/knob_back_64.png")
            self.bmp_fore=wx.Bitmap("img/sets/moog_opus/knob_fore_64.png")
            self.bmp_plate=wx.Bitmap("img/sets/moog_opus/knob_plate_64.png")
        else:
    ...
    def Draw(self, dc):
        ...
        bp=(self.GetSize()[0]-self.bmp_plate.GetSize()[0])/2
        dc.DrawBitmap(self.bmp_plate,bp,bp)
        
if __name__ == "__main__":
    class MyFrame(wx.Frame):
        def __init__(self, parent):
            wx.Frame.__init__(self, parent, -1, "")  
            knob1 = MoogKnobCtrl(self, -1, size=(128, 128))
